...
const PublicView = () => {
  ...
  const ogImage =
    fileType.startsWith("image/")
      ? fileUrl // Use the actual image URL if it's an image
      : "https://images.unsplash.com/photo-1562240020-ce31ccb0fa7d?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjEyMDd9"; // Use a default placeholder for non-images
